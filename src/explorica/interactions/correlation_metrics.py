...
statistical dependency measures between variables.
...
def eta_squared(values: Sequence[Number], categories: Sequence) -> float:
    ...
    validate_lengths_match(
        values,
        categories,
        err_msg=_errors["arrays_lens_mismatch_f"].format("values", "categories"),
    )
    validate_array_not_contains_nan(
        values,
        err_msg=_errors["array_contains_nans_f"].format("values"),
    )
    validate_array_not_contains_nan(
        categories,
        err_msg=_errors["array_contains_nans_f"].format("categories"),
    )
