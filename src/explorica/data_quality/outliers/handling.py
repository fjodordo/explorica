...
def replace_outliers(
    ...
    **kwargs,
    ...
    validate_string_flag(
        detection_method,
        methods["detection"],
        _errors["unsupported_method_f"].format(detection_method, methods["detection"]),
    )
    validate_string_flag(
        strategy,
        methods["fill"],
        _errors["unsupported_method_f"].format(strategy, methods["fill"]),
    )
    validate_array_not_contains_nan(
...
def remove_outliers(
    ...
    **kwargs,
    ...
    supported_methods = {
        "iqr": {"func": detect_iqr, "params": params["iqr_kws"]},
        "zscore": {
            "func": detect_zscore,
            "params": params["zscore_kws"],
        },
